...
public enum WSOutputs implements Outputs {
    ...
    WHEEL("Module 4 Angle Motor", new WsSparkMaxConfig(CANConstants.MOTOR11, true)),
    FEED("Module 4 Angle Motor", new WsSparkMaxConfig(CANConstants.MOTOR12, true)),
    ...
    INTAKE("Test Solenoid", new WsSolenoidConfig(PneumaticsModuleType.REVPH, 0, false)),
    // ********************************
    // Relays
    // ********************************
